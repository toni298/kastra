...
const title = computed(() => props.config.title || 'Promo & Penawaran')
const linkLabel = computed(() => props.config.link_label || 'Lihat Semua')
...
<template>
  <section v-if="shown.length" class="mb-5 mt-14">
    <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
      <div class="flex items-end justify-between" v-reveal="'slide-left'">
        <div>
          <p class="text-[11px] font-bold uppercase tracking-[0.25em] text-slate-400">Hemat</p>
