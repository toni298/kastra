...
<template>
  <Modal
    ...
    description="Dokumen pembelian akan dihapus dari daftar transaksi."
    size="md"
  ...
  >
    ...
    >
      ...
      <div>
        <p class="font-medium text-red-900 dark:text-red-200">{{ transaction.number }}</p>
        <p class="mt-1 text-sm text-red-700 dark:text-red-300">
          Riwayat jurnal dan pembayaran terkait perlu ditinjau untuk kebutuhan audit.
        </p>
      </div>
    </div>
    <template #footer>
